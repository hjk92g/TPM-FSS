...
do
  ...
  do
    ...
    SAVE_FOLDER=results_abd/test_adnet_alpha_20/fold${fd}_${r_n}
    mkdir -p ${SAVE_FOLDER}
    ...
    PRETRAINED2=results_abd/train_adnet_alpha_20_no_t_loss/fold${fd}_${r_n}/ #TPM (ADNet without T loss)
    SAVE_FOLDER2=results_abd/test_adnet_alpha_20_no_t_loss/fold${fd}_${r_n}
